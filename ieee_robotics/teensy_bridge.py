...
class TeensyBridge(Node):
    ...
    def process_serial_and_state_machine(self):
        ...
        try:
            ...
            if self.goal_active and line.startswith('FIRE:'):
    ...
    def fire_detection_state_machine(self, line):
        ...
        if self.current_state == self.STATE_INITIAL:
            ...
            if current_time - self.last_state_change_time > 15:
    ...
    def check_fire_detection(self, line):
        ...
        # Log the current fire detection state for debugging

        self.get_logger().info(f"Checking fire detection: {self.current_fire_detection}")
        ...
        if '1' in line:
            ...
            self.get_logger().info(f"Something is wrong: {self.current_fire_detection}")

            return self.current_fire_detection is False
    ...
    def publish_fire_location(self, angle):
        ...
        if angle == 0:
            ...
            self.get_logger().info(f"Goal Pose not working")
